@extends('layouts.cetak', ['title' => 'Cetak Laporan Produk Harian'])

@section('content')
<div class="container">
    <div class="text-center mb-4">
        <h2>LAPORAN PENJUALAN PRODUK HARIAN</h2>
    ...
    <div class="mb-3">
        <strong>Total Produk Terjual: {{ count($laporanProdukHarian) }} jenis produk</strong>
    </div>
    ...
    <div class="row mt-4">
        <div class="col-6">
            <div class="border p-3">
                ...
                • Jumlah Jenis Produk: {{ count($laporanProdukHarian) }}<br>
                • Total Quantity Terjual: {{ $totalQty }}<br>
    ...
    @else
        <div class="alert alert-warning text-center">
            <h4>Tidak ada data penjualan produk untuk tanggal {{ date('d/m/Y', strtotime($tanggal)) }}</h4>
        </div>
    @endif
</div>
